                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2" x-data="{ name: '', random() { return Math.floor(Math.random() * 1000) + 100 } }">
                            <div>
                                ...
                                <input x-model="name"
                                    x-on:input="$refs.username.value = name.split(' ').join('_').toLowerCase() + random()"
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2" x-data="{ name: '', random() { return Math.floor(Math.random() * 1000) + 100 } }">
                            <div>
                                <label for="edit_name"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
                                <input x-model="name" x-on:input="$refs.username.value = name + random()" type="text"
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <button data-modal-target="edit-modal" data-modal-toggle="edit-modal"
                                        hx-get="{{ route('client.edit', $client) }}" hx-transition
